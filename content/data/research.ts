...
export const ctfParticipations: CTFParticipation[] = [
  {
    ...
    team: 'Team bi0s',
    category: 'Hardware',
    description: 'Hardware security CTF focusing on embedded firmware analysis, protocol reverse engineering, and hardware exploitation.',
  },
  {
    id: 'inctf-2026',
    name: 'InCTF 2026',
    ...
    team: 'Team bi0s',
    category: 'Hardware',
    description: 'India\'s premier CTF organized by Team bi0s. Contributed hardware challenge design and participated in hardware category.',
  },
  {
    id: 'isea-ctf-2026',
    name: 'ISEA CTF 2026',
  ...
  },
  {
    ...
    team: 'Team bi0s',
    category: 'Hardware',
    description: 'Embedded systems and hardware security CTF challenges including firmware extraction and protocol analysis.',
  },
  {
    id: 'eplison-ctf',
    name: 'ESPILON CTF',
    ...
    team: 'Team bi0s',
    category: 'Hardware / Embedded',
    description: 'Solved complex embedded firmware challenge involving ChaCha20 encrypted C2 protocol reverse engineering. Extracted flag via firmware analysis and protocol reconstruction.',
  },
];
